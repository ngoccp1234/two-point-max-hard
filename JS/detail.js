...
function shareSong() {
    ...
    shareOverrideOGMeta('https://tooeasy2get2points.herokuapp.com/song-song-detail.html?id=' + currentSong.id, currentSong.name + ' || Song I Like', currentSong.description, currentSong.thumbnail);
}
